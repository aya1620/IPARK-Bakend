...
class Home extends StatefulWidget {
  ...
  Home({required this.userId, this.name, this.familyName, this.carType});
  @override
...
class _HomeState extends State<Home> {
  ...
  void _showMenu(BuildContext context) async {
    ...
    final List<PopupMenuItem<String>> items = [
      PopupMenuItem<String>(
        value: 'survey', // Corrected value for 'Edit Survey'
        child: Container(
  ...
  Future<void> _reserveParking(int parkingSpot) async {
    ...
    if (response.statusCode == 200) {
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => Home2(userId: widget.userId)),
      );
    }
  }
